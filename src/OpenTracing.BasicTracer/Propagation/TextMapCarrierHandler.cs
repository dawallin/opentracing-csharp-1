...
namespace OpenTracing.BasicTracer.Propagation
{
    ...
    {
        public void MapContextToCarrier(SpanContext context, ITextMapInjectCarrier carrier)
        {
        ...
        public SpanContext MapCarrierToContext(ITextMapExtractCarrier carrier)
        {
        ...
        private Guid? TryGetGuid(ITextMapExtractCarrier carrier, string key)
        {
